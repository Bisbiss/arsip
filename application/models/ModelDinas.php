...
public function editData($tabel_name,$data,$id_nota_dinas)
{
...
public function dataEdit($tabel_name,$id_nota_dinas)
{
    $this ->db->where('id_nota_dinas',$id_nota_dinas);
    $get_user = $this->db->get($tabel_name);
    return $get_user->row();
...
public function hapusData($tabel_name,$id_nota_dinas)
{
    $this ->db->where('id_nota_dinas',$id_nota_dinas);
